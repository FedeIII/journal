...
export default function WeekView({ currentDate, setCurrentDate }: WeekViewProps) {
                  ...
                  {weekDays.map((day) => {
                    ...
                    return (
                      <td
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.backgroundColor = hasEntry ? '#d1d4f0' : '#f0f0f0';
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = hasEntry ? '#e8eaf6' : 'white';
                        }}
                      >
                        {hasEntry && (
